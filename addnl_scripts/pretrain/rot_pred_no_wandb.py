...
from model.resnet import resnet34, resnet34_seg
...
# python addnl_scripts/pretrain/rot_pred_no_wandb.py --batch_size=16 --steps=601 --dataset=multi --source=real --target=sketch --save_dir=expts/rot_pred --expt_name=resnet_seg --ckpt_freq=1 --pre_trained=True &
